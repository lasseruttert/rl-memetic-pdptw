...
TASKS: List[Union[str, List[str]]] = [
    "train_rl_local_search.py --config training_configs/dqn_operator_set_1.yaml",
    "train_rl_local_search.py --config training_configs/dqn_operator_set_2.yaml",
    "train_rl_local_search.py --config training_configs/dqn_operator_set_3.yaml",
    "train_rl_local_search.py --config training_configs/dqn_operator_set_4.yaml",
    "train_rl_local_search.py --config training_configs/ppo_operator_set_1.yaml",
    "train_rl_local_search.py --config training_configs/ppo_operator_set_2.yaml",
    "train_rl_local_search.py --config training_configs/ppo_operator_set_3.yaml",
    "train_rl_local_search.py --config training_configs/ppo_operator_set_4.yaml",
]
